...
class DrawerSecondPage extends StatefulWidget {
  @override
  _DrawerSecondPageState createState() => _DrawerSecondPageState();
}

class _DrawerSecondPageState extends State<DrawerSecondPage> {
  String message = "";
  ...
  var currentPage = DrawerSections.viewOnHand;
  @override
