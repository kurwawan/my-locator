...
class DrawerSixthPage extends StatefulWidget {
  @override
  _DrawerSixthPageState createState() => _DrawerSixthPageState();
}

class _DrawerSixthPageState extends State<DrawerSixthPage> {
  String message = "";
  ...
  var currentPage = DrawerSections.toLocatorBbn;
  @override
