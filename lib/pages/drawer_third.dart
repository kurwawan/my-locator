...
class DrawerThirdPage extends StatefulWidget {
  @override
  _DrawerThirdPageState createState() => _DrawerThirdPageState();
}

class _DrawerThirdPageState extends State<DrawerThirdPage> {
  String message = "";
  ...
  var currentPage = DrawerSections.fromLocator;
  @override
