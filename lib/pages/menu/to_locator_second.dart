...
class ToLocatorSecondPage extends StatefulWidget {
  @override
  _ToLocatorSecondPageState createState() => _ToLocatorSecondPageState();
}

class _ToLocatorSecondPageState extends State<ToLocatorSecondPage> {
  var baseUrl = Config.url;
  String resultCode, varTemp = '';
                                                                    ...
                                                                    if (valId == null ||
                                                                      ...
                                                                      ToLocatorPost.connectToApi(
                                                                        ...
                                                                        LogPost.connectToApi(
                                                                            'Transfer Draft',
                                                                            'To Locator: $resultCode, Description: $resultDesc, Lot Number: $resultLotNum, From Locator: $resultLocDesc, From Sub Inv: $resultFromSubInv, To Sub Inv: $valSubInv, Org Id: $resultOrgId, UOM: $resultUom, Quantity: $resultQty, Transfer Qty: ' +
                                                                                resultQuantity.text,
                                                                            resultPersonId);
