...
import 'menu/to_locator_pratimbang.dart';
import 'menu/to_locator_second.dart';
import 'menu/view_on_hand_scan.dart';

class DrawerFifthPage extends StatefulWidget {
  @override
  _DrawerFifthPageState createState() => _DrawerFifthPageState();
}

class _DrawerFifthPageState extends State<DrawerFifthPage> {
  String message = "";
  ...
  var currentPage = DrawerSections.viewOnHandScan;
  @override
