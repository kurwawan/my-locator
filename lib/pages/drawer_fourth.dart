...
class DrawerFourthPage extends StatefulWidget {
  @override
  _DrawerFourthPage createState() => _DrawerFourthPage();
}

class _DrawerFourthPage extends State<DrawerFourthPage> {
  String message = "";
  ...
  var currentPage = DrawerSections.toLocator;
  @override
